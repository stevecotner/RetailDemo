...
extension Retail {
    struct ViewMaker<E: ActionEvaluating_ProductFinding & ActionEvaluating_OptionToggling>: ObservingPageView_ViewMaker {
        ...
        enum Section: ObservingPageViewSection {
            ...
            case divider
            case instruction(instructionNumber: Observed<Int>, instruction: Observed<String>)
